//source: https://github.com/Paperboy451/jamming
...
const Spotify2 = {
    ...
    getAccessToken() {
        ...
        if (accessToken) {
            ...
            window.location.href = `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=token&scope=playlist-modify-private&redirect_uri=${spotifyRedirectUri}&state=${state}`;
        }
    },
